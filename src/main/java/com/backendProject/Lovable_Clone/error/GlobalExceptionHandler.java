...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(BadRequestException.class)  //when we want to throw exception to ourselves
    ...
    @ExceptionHandler(MethodArgumentNotValidException.class)  //for failed jakarta validation
